...
let s:lightblack  = { "gui": "#2D2E27", "cterm": "NONE" }
" let s:lightblack2 = { "gui": "#383a3e", "cterm": "236" }
let s:lightblack2 = { "gui": "#383a3e", "cterm": "NONE" }
" let s:lightblack3 = { "gui": "#3f4145", "cterm": "237" }
let s:lightblack3 = { "gui": "#3f4145", "cterm": "NONE" }
" let s:darkblack   = { "gui": "#211F1C", "cterm": "233" }
let s:darkblack   = { "gui": "#211F1C", "cterm": "NONE" }
...
call s:h("StatusLineNC",  { "fg": s:darkgrey,   "bg": s:darkblack,     "format": "reverse" })
call s:h("TabLine",       { "fg": s:white,      "bg": s:darkblack,    "format": "reverse" })
call s:h("Visual",        {                     "bg": s:lightgrey })
call s:h("Search",        { "fg": s:black,      "bg": s:darkred })
...
call s:h("FoldColumn",    {                     "bg": s:white2 })
"        Incsearch"
